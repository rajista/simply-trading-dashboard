...
class DataModelTests(unittest.TestCase):
    ...
    def test_build_insights_summarizes_accumulation_and_sector_counts(self):
        ...
        self.assertEqual(insights["sector_stock_tables"][0]["leader"]["display_symbol"], "AAA")
        self.assertEqual(insights["sector_stock_tables"][0]["watchlist"][0]["display_symbol"], "AAA")
        self.assertGreater(insights["sector_stock_tables"][0]["accumulation_ratio"], 0)
...
class RouteTests(unittest.TestCase):
    ...
    def test_dashboard_structure_and_search_routing(self, cached, universe, broad_universe):
        ...
        self.assertIn("/static/css/style.css?v=20260717-7", html)
        self.assertIn("/static/js/dashboard.js?v=20260717-7", html)
    ...
    def test_insights_route_uses_precomputed_snapshot_only(self, snapshot, market_loader, insight_builder):
        ...
        self.assertIn("Sector Highlights", html)
        self.assertIn("Fast read by sector", html)
